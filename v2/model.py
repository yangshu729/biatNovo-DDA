...
class SpectrumCNN(nn.Module):
    ...
    def forward(self, spectrum_holder, dropout_keep):
        ...
        output = output.view(
            -1, 16, 1 * (deepnovo_config.MZ_SIZE // deepnovo_config.SPECTRUM_RESOLUTION // (4))
        )
...
class IonCNN(nn.Module):
    def __init__(self, dropout_keep: dict):
        ...
        self.dense1 = CustomLinear(2560, 512, init_weight=lambda x: variance_scaling_initializer(x, 1.43),
